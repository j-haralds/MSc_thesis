...
\begin{itemize}
    ...
    \item The general working principle: charging and discharging. Potential negative effects that need to be considered. Heat development, or other factors affecting performance of the cell. 
...
\begin{itemize}
    ...
    \item Motivate the use of \glspl{nn} w/ the Universal Approximation Theorem, i.e. the fact that a single layer perceptron \gls{nn} can achieve universallity. Put differently, any continuous function can be modelled to the desired degree of accuracy with this \gls{nn} (\href{https://en.wikipedia.org/wiki/Universal_approximation_theorem}{wiki-link}). 
    \item 
\end{itemize}
\begin{figure}[H]
\centering
