...
\begin{itemize}
    \item Generally describe the setup we're dealing with \eref{eq:pde} to \ref{eq:bound}. \eref{eq:pde} describes the \gls{pde} residual, \eref{eq:init} the \gls{ic} and \eref{eq:bound} the \gls{bc}.
